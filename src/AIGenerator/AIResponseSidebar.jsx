      ...
      <div className='flex justify-end flex-col h-[85%] 1024px:h-[87%] mt-20'>
        ...
        >
          ...
          {isCopied && (
            ...
            >
              <span className='w-[10px] h-[10px] rotate-[45deg] bg-gray-700 absolute bottom-[-4px] left-[50%] transform translate-x-[-50%]'></span>
              Copied
            </motion.p>
          )}
        </button>
        ...
        {isGenerating ? (
          ...
          <SyntaxHighlighter
            language="javascript"
            style={dracula}
            className='zenui_code_snippet overflow-x-scroll rounded-md dark:border-darkBorderColor dark:border h-full 425px:max-w-[380px] 640px:max-w-[780px] 1605px:max-w-[1177px] text-[0.9rem] w-full 1404px:max-w-[1107px] 1024px:max-w-[730px] 1260px:max-w-[880px] max-h-[380px] 1024px:max-h-[480px] max-w-[325px]'
            showLineNumbers
          >
            {codes}
          </SyntaxHighlighter>
