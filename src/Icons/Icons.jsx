    ...
    return (
        <>
            <section className='min-h-screen max-w-[1700px] mx-auto w-full pt-[2rem] 1024px:pt-[3rem] !px-8 425px:!px-10 relative'>
                    ...
                    <div className='absolute top-[110px] 640px:top-[60px] opacity-20 right-[50%] 640px:right-[30%] 1024px:right-[400px] animate-pulse dark:animate-none dark:opacity-10'>
                        <DeleteIcon/>
                    </div>
                    <div className='absolute top-[180px] 640px:top-[140px] opacity-20 right-[14%] 1024px:right-[210px] animate-pulse dark:animate-none dark:opacity-10'>
                        <CursorIcon/>
                    </div>
                    <div className='absolute top-[40px] 640px:top-[40px] opacity-20 right-[0] 640px:right-[60px] animate-pulse dark:animate-none dark:opacity-10'>
                        <ShareIcon/>
                    </div>
                ...
                <div className='mt-6 relative'>
                    <input className='w-full dark:bg-slate-900 dark:border-darkBorderColor 1024px:w-[40%] rounded-md border border-border py-3 pr-4 pl-[40px] focus:border-primary dark:text-darkSubTextColor dark:outline-none dark:focus:outline-none focus:outline-2 focus:outline-primary'
...

                {
                    filteredIcons?.length <= 0 && (
                        <div className='flex items-center justify-center w-full flex-col mt-20'>
                            ...
                            <p className='text-[0.9rem]  text-text mt-2 text-center 640px:text-start dark:text-darkSubTextColor'>Please check the
