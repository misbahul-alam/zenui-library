    ...
    return (
        <section className='px-6 1024px:px-12 py-10 overflow-hidden'>
            ...
            <div className='w-full 1024px:max-w-[1000px] mx-auto mt-6'>
                <h1 className='text-[1.9rem] 640px:text-[2.2rem] font-semibold dark:text-darkTextColor text-gray-900'>ZenUI Hero: How to Join the Hall of Fame</h1>
                <p className='text-[1rem] text-gray-700 mt-2 640px:mt-0.5 dark:text-darkSubTextColor'>Welcome to the official guide on how to become a <b>ZenUI
                ...
                <div className='mt-9'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900 dark:text-darkTextColor'>🌟 What is a ZenUI Hero?</h4>
                    <p className='text-[1rem] text-gray-700 mt-1 ml-2 dark:text-darkSubTextColor'>A <b>ZenUI Hero</b> is a title awarded to contributors
                ...
                <div className='mt-9 relative'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900 dark:text-darkTextColor'>🛠️ How to Become a ZenUI Hero?</h4>
                    <p className='text-[1rem] text-gray-700 mt-1 ml-2 dark:text-darkSubTextColor'>To achieve the <b>ZenUI Hero</b> badge, you must:</p>

                    <p className='mt-4 font-semibold ml-2 text-[1.1rem] text-gray-900 dark:text-darkSubTextColor'>1. Solve a Critical Issue</p>
                    <p className='text-[1rem] text-gray-700 ml-6 mt-1 dark:text-darkSubTextColor'>A critical issue is a problem that:</p>
                    ...
                    <div className='text-[0.9rem] text-gray-700 dark:border-slate-400 dark:bg-slate-800 dark:text-darkSubTextColor border-l-2 bg-yellow-50 border-yellow-500 ml-5 px-5 rounded-md py-3 my-5 w-max'><b>Example: Fixing a bug that causes a complete layout crash when resizing components.</b></div>

                    <p className='mt-9 font-semibold ml-2 text-[1.1rem] text-gray-900 dark:text-darkSubTextColor'>2. Make Significant
                        Contributions</p>
                    <p className='text-[1rem] text-gray-700 dark:text-darkSubTextColor ml-6 mt-1'>If you haven't tackled a critical issue, you can
                    ...
                    <div className='text-[0.9rem] text-gray-700 border-l-2 dark:bg-slate-800 dark:border-slate-400 dark:text-darkSubTextColor bg-yellow-50 border-yellow-500 ml-5 px-5 rounded-md py-3 my-5 w-max'><b>Tip: Consistency matters. Show dedication and quality in every contribution.</b></div>
                </div>

                <div className='mt-14'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900 dark:text-darkTextColor'>📋 Eligibility Criteria</h4>

                    <ul className='list-disc ml-14 mb-5 mt-2 text-gray-700 dark:text-darkSubTextColor flex flex-col gap-[8px]'>
                        <li>You must follow ZenUI’s <b className='underline'><a href='https://github.com/Asfak00/zenui-library/blob/production/CODE_OF_CONDUCT.md' target='_blank'>code of conduct</a></b> and respect the community guidelines.</li>
                        <li>All contributions should align with the ZenUI Library’s <b>mission</b> to provide high-quality UI
                ...
                <div className='mt-9'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900 dark:text-darkTextColor'>🏆 Benefits of Becoming a ZenUI Hero</h4>
                    <p  className='text-[1rem] text-gray-700 mt-1 ml-2 dark:text-darkSubTextColor'>As a ZenUI Hero, you’ll receive:</p>

                    <p className='mt-5 font-semibold ml-2 text-[1.1rem] text-gray-900 dark:text-darkSubTextColor'>1. Recognition:</p>
                    ...
                    <p className='mt-7 font-semibold ml-2 dark:text-darkSubTextColor text-[1.1rem] text-gray-900'>2. Exclusive Perks:</p>
                    ...
                    <p className='mt-7 font-semibold ml-2 text-[1.1rem] dark:text-darkSubTextColor text-gray-900'>3. Networking Opportunities:</p>
                ...
                <div className='mt-9 relative'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900 dark:text-darkTextColor'>✨ Tips to Succeed</h4>
                ...
                <div className='mt-9'>
                    ...
                    <p className='text-[1rem] text-gray-700 mt-1 ml-3 dark:text-darkSubTextColor'>If you have questions or need guidance, feel free to reach out:</p>
                ...
                <p className='text-center 640px:text-start text-[1rem] dark:text-darkSubTextColor text-gray-700 mb-2 mt-16'>We look forward to seeing your contributions and welcoming you as the next <b>ZenUI Hero</b>!</p>
                <b className='text-center flex items-center dark:text-darkSubTextColor justify-center 640px:justify-start text-[1rem] text-gray-700'>Start contributing today and make a difference!</b>
            </div>
        </section>
    );
};
