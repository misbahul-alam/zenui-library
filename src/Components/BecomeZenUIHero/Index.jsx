    ...
    return (
        <section className='px-6 1024px:px-12 py-10 overflow-hidden'>
            ...
            <div className='w-full 1024px:max-w-[1000px] mx-auto mt-6'>
                ...
                <div className='mt-9'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900'>🌟 What is a ZenUI Hero?</h4>
                ...
                <div className='mt-9 relative'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900'>🛠️ How to Become a ZenUI Hero?</h4>
                ...
                <div className='mt-14'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900'>📋 Eligibility Criteria</h4>
                ...
                <div className='mt-9'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900'>🏆 Benefits of Becoming a ZenUI Hero</h4>
                    <p  className='text-[1rem] text-gray-700 mt-1 ml-2'>As a ZenUI Hero, you’ll receive:</p>
                ...
                <div className='mt-9 relative'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900'>✨ Tips to Succeed</h4>
                ...
                <div className='mt-9'>
                    <h4 className='text-[1.5rem] font-semibold text-gray-900'>❓ Need Help?</h4>
