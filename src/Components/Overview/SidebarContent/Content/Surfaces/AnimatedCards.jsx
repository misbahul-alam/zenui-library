          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setAnimatedCard6Preview,
                    setAnimatedCard6Code,
                    true
                  )
                }
              >
              ...
              <div className='p-8 mb-4 flex items-center flex-col gap-5 justify-center'>
                <div className='w-full 640px:w-[80%] 1024px:w-[60%] shadow-md h-[350px] hover:scale-[1.05] transition-all duration-300 overflow-hidden rounded-md relative cursor-pointer group'>
                  ...
                  <div className='absolute bottom-0 left-0 py-[20px] pb-[40px] px-[20px] w-full'>
                    <p className='text-[1rem] uppercase text-gray-600'>
                      Travel
                    </p>
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setAnimatedCard7Preview,
                    setAnimatedCard7Code,
                    true
                  )
                }
              >
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setAnimatedCard8Preview,
                    setAnimatedCard8Code,
                    true
                  )
                }
              >
...
export default AnimatedHoverCard;
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setAnimatedCard9Preview,
                    setAnimatedCard9Code,
                    true
                  )
                }
              >
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setAnimatedCard10Preview,
                    setAnimatedCard10Code,
                    true
                  )
                }
              >
            ...
            {animatedCard10Preview && (
              <div className='p-8 mb-4 flex items-center flex-col gap-5 justify-center'>
                <div className='w-full 640px:w-[80%] 1024px:w-[60%] shadow-md h-[350px] transition-all duration-300 overflow-hidden rounded-md relative cursor-pointer group flex items-center justify-center flex-col gap-[10px]'>
                  ...
                  {/*  the title  */}
                  <h3 className='text-[1.5rem] font-bold z-20'>
                    ZenUI Library
                  </h3>
                </div>
              </div>
        ...
        <div className='1024px:flex hidden flex-col gap-4 sticky top-4 right-0 w-[35%]'>
          ...
          <div
            className='flex flex-col gap-4 overflow-y-auto h-[90vh] pb-[120px]'
            style={{ scrollbarWidth: 'none' }}
          >
            {animatedCardsContents.map((item) => (
              <a
                key={item.id}
                href={item.href}
                className={`${
