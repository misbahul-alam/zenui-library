      ...
      <aside className='flex items-start gap-6 justify-between w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div className='w-full 425px:w-[80%]'>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            Drag & drop with indicator shows where an item will be placed,
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(setDragDrop1Preview, setDragDrop1Code, true)
                }
              >
                Preview
              </button>
              <button
                ...
                onClick={() =>
                  toggleCardView(setDragDrop1Preview, setDragDrop1Code, false)
                }
              >
                Code
              </button>
...
export default DragAndDrop;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            Drag & drop for multiple file uploads lets users easily upload
            ...
            <div className='relative'>
              ...
              >
                ...
                <PremiumTooltip
                  ...
                  url='https://buymeacoffee.com/zenuilibrary/e/319007'
                />
              </button>
            </div>
            {dragDrop2Preview && (
              <div className='p-8 mb-4 flex flex-col items-center gap-5 justify-center'>
                <div className='flex flex-col justify-center items-center w-full'>
                  {/* Drop Zone */}
                  <div
                    className={`border-2 p-6 rounded-lg w-full h-64 flex flex-col justify-center items-center bg-white  ${
                      dragging
                        ...
                        <div className='flex flex-col'>
                          <div className='flex items-start justify-between w-full mb-1'>
                            <div className='flex items-start gap-[10px]'>
                              <CiImageOn className='bg-white rounded-md p-1 border border-gray-200 text-[1.7rem] text-gray-500' />
                              <div>
                                <p className='text-gray-700 font-[500] text-[0.9rem] leading-[20px] 640px:leading-[9px] 640px:mt-0.5'>
                                  {imageObj.file.name}
                                </p>
                          ...
                          {imageObj.cancelled ? (
                            ...
                            <>
                              <div className='flex items-center justify-between gap-[8px]'>
                                <div className='w-full bg-white h-1.5 rounded-lg overflow-hidden'>
                                  <div
                                    className='bg-blue-500 h-full transition-all duration-300'
                                    style={{ width: `${imageObj.progress}%` }}
                                  ></div>
                                </div>
                                <span className='text-[0.7rem] mb-0.5 text-gray-500'>
                                  {imageObj.progress}%
                                </span>
                              </div>
                            </>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            Drag & drop image upload lets users quickly upload images by
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(setDragDrop3Preview, setDragDrop3Code, true)
                }
              >
                Preview
              </button>
              <button
                ...
                onClick={() =>
                  toggleCardView(setDragDrop3Preview, setDragDrop3Code, false)
                }
              >
                Code
              </button>
              ...
              <div className='p-8 mb-4 flex flex-col items-center gap-5 justify-center'>
                <div className='flex justify-center items-center w-full flex-col'>
                  <div
                    ...
                    } rounded-lg w-full h-64 flex flex-col justify-center items-center bg-white`}
...
export default DragAndDrop;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            List drag & drop allows users to rearrange items by dragging and
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(setDragDrop4Preview, setDragDrop4Code, true)
                }
              >
                Preview
              </button>
              <button
                ...
                onClick={() =>
                  toggleCardView(setDragDrop4Preview, setDragDrop4Code, false)
                }
              >
                Code
              </button>
                    ...
                    >
                      <div className='flex items-center gap-[8px] 640px:gap-[15px]'>
                        ...
                        <div className='text-left flex flex-col 640px:gap-[5px]'>
                          <h4 className='text-[1rem] 640px:text-[1.3rem] text-gray-700 font-[600]'>
                            {item.name}
                          </h4>
                          <p className='text-[0.7rem] 640px:text-[0.9rem] text-gray-500'>
                            {item.title}
                          </p>
                        </div>
                      </div>

                      <RiDraggable className='text-[1.5rem] 640px:text-[1.8rem] text-gray-600 cursor-move' />
                    </div>
                  ))}
                </div>
              </div>
...
export default DragAndDrop;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A to-do app with drag & drop lets users easily organize tasks by
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(setDragDrop5Preview, setDragDrop5Code, true)
                }
              >
                Preview
              </button>
              <button
                ...
                onClick={() =>
                  toggleCardView(setDragDrop5Preview, setDragDrop5Code, false)
                }
              >
                Code
              </button>
            ...
            {dragDrop5Preview && (
              <div className='p-8 mb-4 flex 1024px:flex-row flex-col gap-5 justify-center'>
                ...
                >
                  <h4 className='text-xl font-semibold text-gray-700 text-center mb-3'>
                    Todo
                  </h4>
