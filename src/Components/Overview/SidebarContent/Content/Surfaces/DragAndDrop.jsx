    ...
    <>
      <aside className='flex items-start gap-6 justify-between w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div className='w-full 425px:w-[80%]'>
          ...
          <ToggleTab setCode={setDragDrop1Code} code={dragDrop1Code} preview={dragDrop1Preview} setPreview={setDragDrop1Preview}/>
...
export default DragAndDrop;
          ...
          <ToggleTab isPremium={true} componentUrl='https://buymeacoffee.com/zenuilibrary/e/319007' setCode={setDragDrop2Code} isPremiumModalOpen={isPremiumModalOpen} setIsPremiumModalOpen={setIsPremiumModalOpen} code={dragDrop2Code} setPreview={setDragDrop2Preview} preview={dragDrop2Preview}/>
                            ...
                            <div className='flex flex-col'>
                              <div className='flex items-start justify-between w-full mb-1'>
                                <div className='flex items-start gap-[10px]'>
                                  <CiImageOn className='bg-white dark:bg-slate-900/80 dark:border-slate-600 rounded-md p-1 border border-gray-200 text-[1.7rem] text-gray-500' />
                                  <div>
                              ...
                              {imageObj.cancelled ? (
                                  ...
                                  <>
                                    <div className='flex items-center justify-between gap-[8px]'>
                                      <div className='w-full dark:bg-slate-800 bg-white h-1.5 rounded-lg overflow-hidden'>
                                        <div
          ...
          <ToggleTab setCode={setDragDrop3Code} code={dragDrop3Code} setPreview={setDragDrop3Preview} preview={dragDrop3Preview}/>
...
export default DragToUpload;
          ...
          <ToggleTab setCode={setDragDrop4Code} code={dragDrop4Code} preview={dragDrop4Preview} setPreview={setDragDrop4Preview}/>
                  ...
                  <div className='flex flex-col w-full gap-4'>
                    {listItems.map((item) => (
                        ...
                        >
                          ...
                          <RiDraggable className='text-[1.5rem] dark:text-[#abc2d3]/70 640px:text-[1.8rem] text-gray-600 cursor-move' />
                        </div>
                    ))}
                  </div>
                </div>
...
export default DragAndDrop;
          ...
          <ToggleTab setCode={setDragDrop5Code} setPreview={setDragDrop5Preview} code={dragDrop5Code} preview={dragDrop5Preview}/>
