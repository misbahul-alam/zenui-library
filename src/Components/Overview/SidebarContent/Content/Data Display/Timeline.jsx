      ...
      <aside className='flex items-start justify-between gap-6 w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A milestone timeline highlights key events or achievements in a
            project, visually tracking important deadlines and accomplishments
            along a chronological path.
          </p>
...
export default Timeline;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A work progress timeline visually represents the stages of a project
            or task over time, showing milestones, completed steps, and upcoming
            phases in a sequential order.
          </p>
