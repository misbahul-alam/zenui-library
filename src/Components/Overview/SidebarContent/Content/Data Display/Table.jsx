...
const Table = () => {
  ...
  const filteredData2 = useMemo(() => {
    return data2.filter((item) =>
      Object.values(item).some((value) =>
        value.toString().toLowerCase().includes(search2.toLowerCase())
      )
    );
  }, [data2, search2]);
  ...
  const filteredData3 = useMemo(() => {
    return data3.filter((item) =>
      Object.values(item).some((value) =>
        value.toString().toLowerCase().includes(search3.toLowerCase())
      )
    );
  }, [data3, search3]);
      ...
      <aside className='flex items-start justify-between gap-6 w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div>
          ...
          <p className='w-[90vw] 425px:w-[80%] text-text text-[1rem]'>
            A searchable table lets users quickly filter rows by typing into a
          ...
          <div className='w-[90vw] 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(setTable1Preview, setTable1Code, true)
                }
              >
                Preview
              </button>
              <button
                ...
                onClick={() =>
                  toggleCardView(setTable1Preview, setTable1Code, false)
                }
              >
                Code
              </button>
...
export default Table;
          ...
          <p className='w-[90vw] 425px:w-[80%] text-text text-[1rem]'>
            A pagination table displays data in pages, showing a limited number
          ...
          <div className='w-[90vw] 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(setTable2Preview, setTable2Code, true)
                }
              >
                Preview
              </button>
              <button
                ...
                onClick={() =>
                  toggleCardView(setTable2Preview, setTable2Code, false)
                }
              >
                Code
              </button>
                ...
                <div className='w-max mx-auto p-4'>
                  ...
                  <div className='rounded-md border border-gray-200 w-full'>
                    <table className='w-full text-sm'>
                      <thead className='bg-gray-100'>
                        <tr>
                          {Object.keys(initialData2[0]).map(
                            (key) =>
                              key !== 'id' && (
                                <th
                                  key={key}
                  ...
                  <div className='mt-4 flex items-center justify-between'>
                    <div className='flex items-center gap-[5px]'>
                      <div className='text-sm text-gray-500'>
                        ...
                        {Math.min(currentPage * pageSize, sortedData2.length)}{' '}
                        of {sortedData2.length} results
                      </div>
...
export default Table;
          ...
          <p className='w-[90vw] 425px:w-[80%] text-text text-[1rem]'>
            A checkbox table lets users select rows using checkboxes, enabling
          ...
          <div className='w-[90vw] 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(setTable3Preview, setTable3Code, true)
                }
              >
                Preview
              </button>
              <button
                ...
                onClick={() =>
                  toggleCardView(setTable3Preview, setTable3Code, false)
                }
              >
                Code
              </button>
              ...
              <div className='customTable overflow-y-auto p-8 mb-4 flex items-center flex-col gap-5 justify-center'>
                <div className='w-max mx-auto p-4'>
                    ...
                    <table className='w-full text-sm'>
                      <thead className='bg-gray-100'>
                        <tr>
                          ...
                          {Object.keys(initialData3[0]).map(
                            (key) =>
                              key !== 'id' && (
                                <th
                                  key={key}
                  ...
                  <div className='mt-4 flex items-center justify-between'>
                    <div className='flex items-center gap-[5px]'>
                      <div className='text-sm text-gray-500'>
                        Showing {(currentPage3 - 1) * pageSize3 + 1} to{' '}
                        {Math.min(currentPage3 * pageSize3, sortedData3.length)}{' '}
                        of {sortedData3.length} results
                      </div>
