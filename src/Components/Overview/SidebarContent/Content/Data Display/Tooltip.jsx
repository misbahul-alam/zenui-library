      ...
      <aside className='flex items-start justify-between gap-6 w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div className='w-full 425px:w-[80%]'>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is a tooltip component. Provide contextual information with a
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setRoundedTooltipPreview,
                    setRoundedTooltipCode,
                    true
                  )
                }
              >
...
export default RoundedTooltip;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is a tooltip component with an arrow indicator for clear
...
export default ArrowTooltip;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A tooltip system that can appear in any position..left, right, top,
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setRelativeAnimationPreview,
                    setRelativeAnimationCode,
                    true
                  )
                }
              >
...
export default Tooltip;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A small pop-up displaying key details about a user's profile when
            hovered or clicked.
          </p>
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setProfileTooltipPreview,
                    setProfileTooltipCode,
                    true
                  )
                }
              >
              ...
              <div className='p-8 pb-20 mb-4 pt-20 flex items-center flex-col gap-5 justify-center'>
                ...
                >
                  ...
                  <div
                    ...
                    } absolute top-[-270px] left-[50%] transform translate-x-[-50%] bg-white w-[250px] rounded-md p-[15px] shadow-md transition-all duration-300`}
                  >
                    {/*  socials  */}
                    <div className='flex items-center justify-between border-b border-gray-200 pb-[7px]'>
                      <p className='text-[1rem] font-[600] text-gray-700'>
                        Socials
                      </p>
                      <div className='flex items-center gap-[8px]'>
                        <a href='https://zenui.net'>
                          <FaLinkedin className='text-[1.3rem] text-gray-700 hover:text-primary cursor-pointer hover:scale-[1.2] transition-all duration-200 ease-out' />
                        </a>
                        <a href='https://zenui.net'>
                          <FaGithubSquare className='text-[1.3rem] text-gray-700 hover:text-primary cursor-pointer hover:scale-[1.2] transition-all duration-200 ease-out' />
                        </a>
                        <a href='https://zenui.net'>
                          <FaInstagramSquare className='text-[1.3rem] text-gray-700 hover:text-primary cursor-pointer hover:scale-[1.2] transition-all duration-200 ease-out' />
                        </a>
                      </div>
                    </div>
...
export default ProfileTooltip;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A brief pop-up providing additional information when clicked,
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setClickedTooltipPreview,
                    setClickedTooltipCode,
                    true
                  )
                }
              >
                ...
                <div className='flex items-center gap-[10px] justify-center flex-wrap'>
                  ...
                  <div className='relative'>
                    <button
                      ...
                      className='left_button py-2 px-6 border rounded-md border-gray-800 text-[1rem] font-[500] text-gray-800'
                    >
                      Left
                    </button>
                    ...
                    <p
                      ...
                      } absolute top-[50%] transform translate-y-[-50%] left-[-130px] w-fit py-[7px] px-[20px] rounded-md bg-gray-800 text-[0.9rem] text-white font-[400] transition-all duration-200`}
                    >
                      Left Tooltip
                      {/* arrow */}
                  ...
                  <div className='relative'>
                    <button
                      ...
                      className='top_button py-2 px-6 border rounded-md border-gray-800 text-[1rem] font-[500] text-gray-800'
                    >
                      Top
                    </button>
                  ...
                  <div className='relative'>
                    <button
                      ...
                      className='bottom_button py-2 px-6 border rounded-md border-gray-800 text-[1rem] font-[500] text-gray-800'
                    >
                      Bottom
                    </button>
                    ...
                    <p
                      className={`${
                        bottomClicked
                          ? 'opacity-100 z-[100] translate-y-0'
                          : 'opacity-0 z-[-1] translate-y-[-20px]'
                      } absolute left-[50%] transform translate-x-[-50%] bottom-[-50px] w-max py-[7px] px-[20px] rounded-md bg-gray-800 text-[0.9rem] text-white font-[400] transition-all duration-200`}
                    >
                      Bottom Tooltip
                      {/* arrow */}
                  ...
                  <div className='relative'>
                    <button
                      ...
                      className='right_button py-2 px-6 border rounded-md border-gray-800 text-[1rem] font-[500] text-gray-800'
                    >
                      Right
                    </button>
                    ...
                    <p
                      className={`${
                        rightClicked
                          ? 'opacity-100 z-[100] translate-x-0'
                          : 'opacity-0 z-[-1] translate-x-[-20px]'
                      } absolute top-[50%] transform translate-y-[-50%] right-[-140px] w-fit py-[7px] px-[20px] rounded-md bg-gray-800 text-[0.9rem] text-white font-[400] transition-all duration-200`}
                    >
                      Right Tooltip
                      {/* arrow */}
