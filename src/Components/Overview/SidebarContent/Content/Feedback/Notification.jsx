      ...
      <aside className='flex items-start justify-between gap-6 w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div className='w-full 425px:w-[80%]'>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is a border notification component. Highlight important
...
export default Notification;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is a notification with a close icon for easy dismissal on user
            interaction.
          </p>
...
export default Notification;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is a notification with a close icon. Customize its position for
...
export default Notification;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A real-time notification sent to users' devices or browsers,
...
export default Notification;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A notification with an integrated progress bar, displaying the
