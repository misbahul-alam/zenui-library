...
const ShowCode = ({ code }) => {
  ...
  return (
    <div className="transition-all duration-300 ease-in-out relative">
      ...
      <SyntaxHighlighter language="jsx" className='text-[14px] 1404px:max-w-[700px] max-h-[400px] 400px:max-w-[380px] 425px:max-w-[638px] max-w-[320px]' style={dracula} showLineNumbers>
        {code}
      </SyntaxHighlighter>
    </div>
  );
